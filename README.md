...
A simple app to put a 5 days weather forecast into 160 characters.<br />The response can be sent via SMS, for example, if a recipient doesn't have access to the Internet.<br />
